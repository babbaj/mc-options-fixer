...
public class SettingFIxer {
    private static ImmutableBiMap<String, Integer> CONVERSION_MAP = ImmutableBiMap.<String, Integer>builder()
    ...
    public static String fix(String key) {
        ...
        Integer old = CONVERSION_MAP.get(key);
        if (old != null) {
